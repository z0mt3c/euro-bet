...
privileged aspect TeamDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    private TeamGroupDataOnDemand TeamDataOnDemand.teamGroupDataOnDemand;
    
    public Team TeamDataOnDemand.getNewTransientTeam(int index) {
        Team obj = new Team();
        setExternalTeamId(obj, index);
        setName(obj, index);
        setTeamGroup(obj, index);
        return obj;
    }
    
    public void TeamDataOnDemand.setExternalTeamId(Team obj, int index) {
        Long externalTeamId = new Integer(index).longValue();
        obj.setExternalTeamId(externalTeamId);
    }
    ...
    public void TeamDataOnDemand.setTeamGroup(Team obj, int index) {
        TeamGroup teamGroup = teamGroupDataOnDemand.getRandomTeamGroup();
        obj.setTeamGroup(teamGroup);
    }
